...
function motVersLigne(m, userId) {
  return {
    ...
    repetition: m.repetition ?? 0,
    ease_facteur: m.easeFacteur ?? 2.5,
    intervalle_jours: m.intervalleJours ?? null,
...
function ligneVersMot(l) {
  return {
    ...
    repetition: l.repetition ?? 0,
    easeFacteur: l.ease_facteur ?? 2.5,
    intervalleJours: l.intervalle_jours ?? null,
